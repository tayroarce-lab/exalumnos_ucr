    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-10 px-4 sm:px-6 lg:px-8 font-sans text-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-esmeralda mb-1">Directorio de Estudiantes</h1>
            <p className="text-sm text-slate-500">Encuentra proyectos innovadores que necesitan tu apoyo.</p>
          </div>
