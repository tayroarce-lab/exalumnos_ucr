            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-6 pb-6 border-b border-slate-100">
              <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
                ...
                <div className="space-y-1">
                  ...
                  <span className="inline-block bg-[#004C63]/10 text-[#004C63] text-[10px] font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">
                    Administrador
                  </span>
    ...
    <div className="py-8 px-6 lg:px-10">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {activeTab === 'academica' && (
          ...
          {activeTab === 'profesional' && (
            <div className="space-y-6">
              <h3 className="font-display font-bold text-base text-slate-700 uppercase tracking-wider pb-2 border-b border-slate-100">Experiencia Profesional</h3>
              <div className="space-y-6">
                {experience.length > 0 ? experience.map((exp, idx) => (
                  <div key={idx} className="relative pl-6 border-l-2 border-slate-200 space-y-1.5">
                    ...
                    <div className="flex justify-between items-start gap-2">
                      <h4 className="text-sm font-bold text-slate-800 uppercase tracking-wide">{exp.role}</h4>
                      <span className="text-[10px] bg-slate-100 text-slate-500 font-bold px-2 py-0.5 rounded-full">{exp.period}</span>
                    </div>
