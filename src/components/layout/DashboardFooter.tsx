      ...
      <div className="footer-contenido">
        ...
        <div className="footer-columna">
          ...
          <ul className="footer-lista">
            <li><Link href="/directorio" className="footer-enlace">Directorio</Link></li>
            <li><Link href="/mentorships" className="footer-enlace">Mentorías</Link></li>
            <li><Link href="/events" className="footer-enlace">Eventos</Link></li>
            <li><Link href="/jobs" className="footer-enlace">Bolsa de Empleo</Link></li>
            <li><Link href="/profile" className="footer-enlace">Mi Perfil</Link></li>
          </ul>
        </div>
